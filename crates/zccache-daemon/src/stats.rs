...
impl PhaseProfiler {
    ...
    /// to populate [`zccache_monocrate::protocol::SessionStats::phase_profile`]. The
...
/// [`zccache_monocrate::protocol::PhaseProfileSummary`] so the conversion is
/// field-for-field.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl From<PhaseTotals> for zccache_monocrate::protocol::PhaseProfileSummary {
...
mod tests {
    ...
    fn totals_snapshot_round_trips_to_phase_profile_summary() {
        ...
        let summary: zccache_monocrate::protocol::PhaseProfileSummary = totals.clone().into();
