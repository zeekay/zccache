...
//!
//! Run all:    uv run cargo test -p zccache-daemon --test ninja_rebuild_test -- --nocapture
...
///
/// Run:  uv run cargo test -p zccache-daemon --test ninja_rebuild_test -- stress_large_project --ignored --nocapture
#[tokio::test(flavor = "multi_thread", worker_threads = 4)]
#[ignore]
...
///
/// Run:  uv run cargo test -p zccache-daemon --test ninja_rebuild_test -- bench_medium --ignored --nocapture
#[tokio::test(flavor = "multi_thread", worker_threads = 4)]
#[ignore]
...
///
/// Run:  uv run cargo test -p zccache-daemon --test ninja_rebuild_test -- meson_ninja_cold --ignored --nocapture
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore]
...
///
/// Run:  uv run cargo test -p zccache-daemon --test ninja_rebuild_test -- meson_ninja_bench --ignored --nocapture
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore]
