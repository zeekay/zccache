...
pub fn request_to_prost(
    ...
    let body = match request {
        crate::protocol::Request::Ping => Body::Ping(zccache_v1::Empty {}),
        crate::protocol::Request::Shutdown => Body::Shutdown(zccache_v1::Empty {}),
        crate::protocol::Request::Status => Body::Status(zccache_v1::Empty {}),
        crate::protocol::Request::Clear => Body::Clear(zccache_v1::Empty {}),
        crate::protocol::Request::Lookup { cache_key } => Body::Lookup(zccache_v1::Lookup {
            cache_key: cache_key.clone(),
        }),
        crate::protocol::Request::Store {
            cache_key,
            artifact,
        ...
        crate::protocol::Request::SessionStart {
            client_pid,
            working_dir,
            log_file,
            track_stats,
        ...
        crate::protocol::Request::Compile {
            session_id,
            args,
            cwd,
            compiler,
        ...
        crate::protocol::Request::SessionEnd { session_id } => {
            Body::SessionEnd(zccache_v1::SessionEnd {
                session_id: session_id.clone(),
            })
        }
        crate::protocol::Request::CompileEphemeral {
            client_pid,
            working_dir,
            compiler,
            args,
        ...
        crate::protocol::Request::LinkEphemeral {
            client_pid,
            tool,
            args,
            cwd,
        ...
        crate::protocol::Request::SessionStats { session_id } => {
            Body::SessionStats(zccache_v1::SessionStatsRequest {
                session_id: session_id.clone(),
            })
        }
        crate::protocol::Request::FingerprintCheck {
            cache_file,
            cache_type,
            root,
            extensions,
        ...
        crate::protocol::Request::FingerprintMarkSuccess { cache_file } => {
            Body::FingerprintMarkSuccess(zccache_v1::FingerprintMarkSuccess {
                cache_file: Some(path_to_prost(cache_file)),
            })
        }
        crate::protocol::Request::FingerprintMarkFailure { cache_file } => {
            Body::FingerprintMarkFailure(zccache_v1::FingerprintMarkFailure {
                cache_file: Some(path_to_prost(cache_file)),
            })
        }
        crate::protocol::Request::FingerprintInvalidate { cache_file } => {
            Body::FingerprintInvalidate(zccache_v1::FingerprintInvalidate {
                cache_file: Some(path_to_prost(cache_file)),
            })
        }
        crate::protocol::Request::ListRustArtifacts => {
            Body::ListRustArtifacts(zccache_v1::Empty {})
        }
        crate::protocol::Request::GenericToolExec {
            tool,
            args,
            cwd,
            env,
        ...
        crate::protocol::Request::ReleaseWorktreeHandles { path } => {
...
pub fn request_from_prost(
    request: zccache_v1::Request,
) -> Result<crate::protocol::Request, String> {
    use zccache_v1::request::Body;

    match request.body {
        Some(Body::Ping(_)) => Ok(crate::protocol::Request::Ping),
        Some(Body::Shutdown(_)) => Ok(crate::protocol::Request::Shutdown),
        Some(Body::Status(_)) => Ok(crate::protocol::Request::Status),
        Some(Body::Clear(_)) => Ok(crate::protocol::Request::Clear),
        Some(Body::Lookup(lookup)) => Ok(crate::protocol::Request::Lookup {
            cache_key: lookup.cache_key,
        }),
        Some(Body::Store(store)) => Ok(crate::protocol::Request::Store {
        ...
        Some(Body::SessionStart(start)) => Ok(crate::protocol::Request::SessionStart {
        ...
        Some(Body::Compile(compile)) => Ok(crate::protocol::Request::Compile {
        ...
        Some(Body::SessionEnd(end)) => Ok(crate::protocol::Request::SessionEnd {
            session_id: end.session_id,
        }),
        Some(Body::CompileEphemeral(compile)) => Ok(crate::protocol::Request::CompileEphemeral {
        ...
        Some(Body::LinkEphemeral(link)) => Ok(crate::protocol::Request::LinkEphemeral {
        ...
        Some(Body::SessionStats(stats)) => Ok(crate::protocol::Request::SessionStats {
            session_id: stats.session_id,
        }),
        Some(Body::FingerprintCheck(check)) => Ok(crate::protocol::Request::FingerprintCheck {
        ...
        Some(Body::FingerprintMarkSuccess(mark)) => {
            Ok(crate::protocol::Request::FingerprintMarkSuccess {
                cache_file: path_from_prost(required_prost_field(
                    mark.cache_file,
        ...
        Some(Body::FingerprintMarkFailure(mark)) => {
            Ok(crate::protocol::Request::FingerprintMarkFailure {
                cache_file: path_from_prost(required_prost_field(
                    mark.cache_file,
        ...
        Some(Body::FingerprintInvalidate(invalidate)) => {
            Ok(crate::protocol::Request::FingerprintInvalidate {
                cache_file: path_from_prost(required_prost_field(
        ...
        Some(Body::ListRustArtifacts(_)) => Ok(crate::protocol::Request::ListRustArtifacts),
        Some(Body::GenericToolExec(exec)) => Ok(crate::protocol::Request::GenericToolExec {
        ...
        Some(Body::ReleaseWorktreeHandles(release)) => {
            Ok(crate::protocol::Request::ReleaseWorktreeHandles {
