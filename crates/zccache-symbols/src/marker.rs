...
/// running this after any stripping step, because strip would clip the
/// footer, and before any signing step because Authenticode/codesign cover
/// trailing bytes once we sign artifacts at all.
///
...
mod tests {
    ...
    fn missing_magic_returns_none() {
        ...
        // magic slot left as zeros, so this should not parse.
